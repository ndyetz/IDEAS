...
THISDATA <- read_excel("../Data/IDEAS_data.xlsx") 
```
...
vl <- subset(varlist, Scale=="sex_choice" & Variable != "K1" & Variable != "K26")
vl$Scale <- NULL
row.names(vl) <- NULL
...
vl <- subset(varlist, Variable=="K26")
vl$Scale <- NULL
row.names(vl) <- NULL
